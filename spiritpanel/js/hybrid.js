...
(function () {
  ...
  function makeOptions() {
    ...
    var o = {
      ...
      /* coins Graphtec : le V10 de secours les laisse libres dès le départ ;
         le plan Sparrow est corrigé à l'arrivée (main.js, setExternalResult) */
      cornerGuard: !!($id('graphtec') && $id('graphtec').checked),
      cornerGuardSize: parseFloat($id('gsize') && $id('gsize').value) || 25
    };
    return o;
  }
    ...
    function attempt(ridx) {
      ...
      try {
        built = SparrowBridge.buildInstance(norm.parts, {
          ...
          cornerNotchMm: opt.cornerGuard ? (opt.cornerGuardSize || 25) : 0
        });

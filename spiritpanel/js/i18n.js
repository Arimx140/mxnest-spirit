...
var I18N = (function () {
  ...
  var EN = {
    'lbl.stickers': 'Sticker fill',
    'txt.stickers': 'Up to 3 models, taken from any open document. They share the waste in turns; the sheet never gets longer.',
    'btn.fpick': 'Use the selection as sticker',
    'msg.fnone': 'No sticker loaded.',
    'lbl.fmode': 'Size', 'fm.fixed': 'Original', 'fm.free': 'Variable',
    'lbl.fmin': 'Min (%)', 'lbl.fmax': 'Max (%)', 'lbl.fcount': 'Max count',
    'lbl.frot': 'Sticker rotation', 'frot.0': 'None', 'frot.90': 'Quarter turns',
    'frot.45': 'Every 45°', 'frot.15': 'Every 15°', 'frot.5': 'Every 5°',
    'lbl.fsteps': 'Size steps', 'btn.ffill': 'Fill the gaps', 'btn.fapply': 'Place stickers',
    'btn.fclear': 'Remove stickers',
    'chk.graphtec': 'Free corners for Graphtec marks',
    'lbl.profiles': 'Setting profiles', 'lbl.profsel': 'Profile', 'lbl.profname': 'Name',
    'btn.profsave': 'Save', 'btn.profload': 'Load', 'btn.profren': 'Rename', 'btn.profdel': 'Delete',
    'txt.profiles': 'A profile keeps every setting: width, gap, margins, search, Graphtec corners, marks, offset, stickers. The last settings are restored at every start anyway.',
